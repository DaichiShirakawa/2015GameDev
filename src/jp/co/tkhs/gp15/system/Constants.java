package jp.co.tkhs.gp15.system;

import java.text.DecimalFormat;
import java.util.Random;

/**
 * ゲーム全体に関わる各種定数の定義 およびRandom等ゲーム内利用の汎用オブジェクトを保持
 *
 * @author tokiha0s
 *
 */
public final class Constants {
    ...
    public static final String TOKISHOOTING_FOLDER_STRING = IMAGE_FOLDER_STRING + "tokishooting/";
    ...
    public static final String FONT_MSGOTHIC_FILEPATH = RESOURCE_FOLDER_STRING
            + "font/MSGOTHIC.TTC";
    public static final String FONT_RICTY_FILEPATH = RESOURCE_FOLDER_STRING + "font/Ricty.ttf";
     ...
     * テキスト処理関連
     */
    public static final DecimalFormat FORMAT_FLOAT_0D0 = new DecimalFormat("0.0");
